...
//        System.out.println(bookStore.findMagazinebyName("Sống đẹp"));
//        System.out.println(bookStore.sortByTitleThenByYearPublishing());
        System.out.println(bookStore.getPublicationCountByYear());
